    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{route(@$alternatif ? 'kelola-alternatif.update' : 'kelola-alternatif.store', @$alternatif ?? '')}}">
                    @csrf
                    @if(@$alternatif)
                        @method('PUT')
                    @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control @error('kode_alternatif') is-invalid @enderror" id="kode_alternatif" name="kode_alternatif"
                                       placeholder="misal A1..." value="{{old('kode_alternatif') ?? @$alternatif['kode_alternatif']}}"
                                >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control @error('nama_alternatif') is-invalid @enderror" id="nama_alternatif" name="nama_alternatif"
                                       placeholder="Nama menu Makanan, dll."  value="{{old('nama_alternatif') ?? @$alternatif['nama_alternatif']}}"
                                >
                    ...
                    <div class="card-footer">
                        <div class="col-sm-6 offset-sm-2">
                            ...
                            <a class="btn btn-default" href="{{route('kelola-alternatif.index')}}">Batal</a>
                        </div>
                    </div>
                    <!-- /.card-footer -->
                </form>
